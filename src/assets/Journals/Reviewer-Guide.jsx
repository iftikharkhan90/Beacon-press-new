...
const ReviewerGuide = () => {
  return (
    <div className="px-8 ml-60 mr-60 leading-loose text-justify py-6">
      <h1 className="text-2xl font-sans font-bold mb-4">Reviewer Guide</h1>
      ...
      <h2 className="text-lg font-sans font-semibold mt-6">1. Responsibilities of Reviewers</h2>
      ...
      <h2 className="text-lg font-sans font-semibold mt-6">2. Review Process</h2>
      <p className='text-sm font-bold font-sans'>Reviewers are expected to assess the manuscript based on the following criteria:</p>
      <ol className="list-decimal text-sm font-sans ml-6">
      ...
      <h2 className="text-lg font-sans font-semibold mt-6">3. Structure of the Review Report</h2>
      <p className='text-sm font-sans font-bold'>Reviewers should structure their comments clearly and professionally:</p>
      <ol className="list-decimal text-sm font-sans ml-6">
      ...
      <h2 className="text-lg font-sans font-semibold mt-6">4. Reviewer Ethics</h2>
      <ol className="list-decimal text-sm font-sans ml-6">
      ...
      <h2 className="text-lg font-sans font-semibold mt-6">5. Confidentiality</h2>
      <p className='text-sm font-sans'>
      ...
      <h2 className="text-lg font-sans font-semibold mt-6">6. How to Submit Your Review</h2>
      <ol className="list-decimal text-sm font-sans ml-6">
