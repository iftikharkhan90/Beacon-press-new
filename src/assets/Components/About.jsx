    ...
    <div className="bg-gray-100 text-black">
      ...
      <section className="relative bg-gradient-to-r from-grey-100 text-black py-10 px-6 md:px-20">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-2xl md:text-2xl font-bold font-sans mb-4">About Beacons-Press</h1>
          <p className="text-lg md:text-lg font-sans font-light">
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-20 py-16">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white rounded-2xl border-gray-100">
            <h2 className="p-2 w-full max-w-md text-2xl font-bold font-sans text-center">Our Mission</h2>
            <p className="text-black leading-relaxed rounded-2xl font-sans text-sm shadow-xl p-6">
          ...
          <div className="bg-white rounded-2xl border-gray-100">
            ...
            <p className="text-black p-9 text-sm font-sans leading-relaxed rounded-2xl shadow-xl">
      ...
      <section className="bg-white py-16 px-7 md:px-20 p-3">
        <div className="max-w-5xl mx-auto bg-gray-100 p-5 rounded-2xl border-white">
          <h2 className="text-2xl font-sans text-center font-bold mb-6">Our Story</h2>
          <p className="text-black text-sm font-sans leading-relaxed mb-4">
      ...
      <section className="bg-gray-100 py-16 px-6 md:px-20">
        <div className="max-w-5xl mx-auto p-5 bg-white rounded-2xl border-gray-100">
          <h2 className=" font-sans text-2xl font-bold text-center mb-6">Editorial Standards & Ethics</h2>
          <p className="text-black font-sans text-sm leading-relaxed">
      ...
      <section className="bg-white py-16 px-6 md:px-20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-sans font-bold mb-8 text-center">Our Global Presence</h2>
          <div className="grid md:grid-cols-3 gap-8 text-center bg-gray-100 shadow-2xl max-w-5xl mx-auto p-5 rounded-2xl border-white">
            {[
              ...
              <div key={idx} className="p-6 border rounded-lg shadow-sm hover:shadow-md transition">
                <h3 className="text-lg font-semibold font-sans">{office.country}</h3>
                <p className="text-gray-600 font-sans text-sm ">{office.role}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r bg-gray-100 text-black py-12 px-6 md:px-20">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-2xl font-sans font-bold mb-4">Get in Touch</h2>
          <p className="mb-6 text-sm font-sans">For press inquiries, partnerships, or media requests:</p>
          <a
            href="mailto:contact@beacons-press.com"
            className="inline-block font-sans text-sm bg-white text-blue-900 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition"
          >
